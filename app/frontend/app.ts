...
import { createAppState, isScanReviewBusy, type AppContext } from "./app-context.js";
...
void (async () => {
  ...
  if (isNone(ctx.state.activePet) && ctx.state.pets.length > 0) core.showGuide();
...
export function hasBlockingUiWork(): boolean {
