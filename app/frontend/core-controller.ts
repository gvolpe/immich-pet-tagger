...
function renderEmptyPetState(ctx: AppContext): void {
...
export function createCoreController(ctx: AppContext): CoreController {
  ...
  const selectPet = async (name: string | null | undefined): Promise<void> => {
